...
# Resolve paths — support Termux home-dir layout via env vars
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))

# Chat history lives in ~/tinyllama/chat_data/ when running under Termux,
...
# Allow start.sh to override the HTML path via FASTCHAT_HTML env var
