...
_home_base = os.path.join(os.path.expanduser("~"), ".local", "share", "tinyllama", "chat_data")
CHATS_DIR = _home_base if os.path.isdir(os.path.join(os.path.expanduser("~"), ".local", "share", "tinyllama")) \
...
HTML_FILE = os.environ.get("FASTCHAT_HTML") or os.path.join(SCRIPT_DIR, "FastChatUI.html")
